...
var PointGaming = global.PointGaming,
    ...
    cleanupUserChatroomSocket = function (socket, user_id, chatroom, callback) {
    ...
    cleanupSocketChatrooms = function (socket, user_id, callback) {
    ...
    cleanupSocketUser = function (socket, callback) {
    ...
    cleanupServerSockets = function (sockets, callback) {
